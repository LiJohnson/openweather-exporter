...
var (
	...
	city        = app.Flag("city", "City for Openweather to gather metrics from. (Format: <cityGeoQueryString>[:<cityDisplayName>][|<cityGeoQueryString>[:<cityDisplayName>]]*)").Envar("OW_CITY").Default("New York").String()
